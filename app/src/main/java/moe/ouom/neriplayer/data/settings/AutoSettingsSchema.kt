...
object AutoSettingsSchema {
    ...
    object general {
        ...
        @AutoSetting(
            key = "suppress_netease_no_permission_hint",
            type = SettingValueType.Boolean,
            defaultBoolean = false,
            order = 60,
            access = SettingAccessMode.KeyOnly
        )
        val suppressNeteaseNoPermissionHint = Unit
    ...
    object personalization {
        ...
        @AutoSetting(
            key = "home_card_recent",
            type = SettingValueType.Boolean,
            defaultBoolean = true,
            titleRes = "recent_title",
            order = 40,
            ui = SettingUiType.Custom
        )
        val homeCardRecent = Unit
    ...
    object motion {
        ...
        @AutoSetting(
            key = "lyric_default_offset_ms",
            type = SettingValueType.Long,
            defaultLong = DEFAULT_LYRIC_DEFAULT_OFFSET_MS,
            titleRes = "settings_lyrics_offset_default",
            descriptionRes = "settings_lyrics_offset_expand",
            order = 100,
            ui = SettingUiType.Custom,
            access = SettingAccessMode.KeyOnly
        )
        val lyricDefaultOffsetMs = Unit
    }
