...
import io.github.camtulip.metadata.lyrics.core.utils.LrcMetadataHelper
import io.github.camtulip.metadata.lyrics.core.utils.parseAsTime
        ...
        return SyncedLyrics(
            ...
            artists = attributes.artist?.let { artistStr ->
                artistStr.split("/").map { part ->
                    ...
                    if (segments.size == 2) io.github.camtulip.metadata.lyrics.core.model.Artist(segments[0], segments[1])
                    else io.github.camtulip.metadata.lyrics.core.model.Artist("Main", part)
                }
            } ?: emptyList()
        )
    }
